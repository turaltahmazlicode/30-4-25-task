...
using _30_4_25_task.ViewModels;
...
public class HomeController : Controller
{
    public IActionResult Index()
    {
        ...
        {
            Services = new List<Service> { service1, service2, service3 },
            Brands = new List<Brand> { brand1, brand2, brand3, brand4, brand5, brand6 },
            ClientReviews = new List<ClientReview> { clientReview1, clientReview2, clientReview3 },
            FeaturedCars = new List<FeaturedCar> { featuredCar1, featuredCar2, featuredCar3, featuredCar4, featuredCar5, featuredCar6, featuredCar7, featuredCar8 },
            NewCars = new List<NewCar> { newCar1, newCar2, newCar3 }
        };
